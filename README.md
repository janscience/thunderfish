...
- [`audianthunder`](https://bendalab.github.io/thunderfish/api/audianthunder.html): [audian](https://bendalab.github.io/audian) with thunderfish integrated as analysis tool.
